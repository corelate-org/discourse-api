exports = module.exports = function(Discourse) {
  ...
  Discourse.prototype.search = function(term, callback) {
    this.get('search.json', { q: term }, function(error, body, httpCode) {
      callback(error, body, httpCode);
    });
  };

  Discourse.prototype.query = function(term, callback) {
    this.get('/search/query.json', { term: term }, function(error, body, httpCode) {
      callback(error, body, httpCode);
    });
  };
